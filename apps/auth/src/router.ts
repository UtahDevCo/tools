...
export function createRouter() {
  ...
  app.patch('/api/auth/user/preferences', authMiddleware, handleUpdatePreferences);
  app.get('/api/auth/user/sessions', authMiddleware, handleListSessions);
  app.delete('/api/auth/user/sessions/:sessionId', authMiddleware, handleRevokeSession);
