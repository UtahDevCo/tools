 ...
 *
 * The E2E tests in test/e2e/ test the UserDO behavior indirectly through the auth API.
 */

describe.skip("UserDO (Integration - Requires direct Durable Object access)", () => {
  it("placeholder - see test/e2e/ for functional tests", () => {
    // This is a placeholder test suite
    // UserDO functionality is tested via E2E tests in test/e2e/auth-flow.test.ts
  });
});
